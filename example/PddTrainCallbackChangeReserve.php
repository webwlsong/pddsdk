<?php
/**
 * 示例接口名称：pdd.train.callback.change.reserve
*/
require_once dirname(__FILE__).'/Config.php';
require_once dirname(__FILE__)."/../vendor/autoload.php";

use pddsdk\PopHttpClient;
use pddsdk\Api\Request\PddTrainCallbackChangeReserveRequest;
$client = new PopHttpClient(Config::$clientId, Config::$clientSecret);

$request = new PddTrainCallbackChangeReserveRequest();

$request->setArriveDate('str');
$request->setArriveStation('str');
$request->setArriveTime('str');
$request->setChangePay(1);
$request->setChangeRefund(1);
$request->setCode(1);
